...
export default function Produtos() {
        ...
        if (confirm("Deseja realmente excluir o produto " + produtoParaExcluir.nome)) {
            produtoService.excluir(produtoParaExcluir.id)
                .then(() => {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: `Produto ${produtoParaExcluir.nome}, foi excluido com sucesso!`,
    ...
    const salvar = () => {
        if (!produto.nome || !produto.quantidadeEstoque) {
            Swal.fire({
                icon: 'error',
                text: 'Nome e quantidade em Estoque são obrigatórios.'
            });
                        ...
                        <div className="modal-body">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-2">
                                    ...
                                    <input id="quantidadeEstoque" type="number" class="form-control"
                                ...
                                <div className="col-sm-3">
                                    ...
                                    <input id="observacao" type="text" class="form-control" placeholder="Original/Paralelo"
